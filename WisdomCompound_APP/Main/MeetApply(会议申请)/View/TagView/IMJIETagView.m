...
-(id)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        self.clickBackgroundColor = [UIColor colorWithHexString:MainBlueColor];
        self.clickTitleColor = [UIColor colorWithHexString:TextColor_ff];
        self.clickArray = nil;
        self.clickbool = YES;
        self.borderSize = 0.5;
...
-(void)setTagsFrame:(IMJIETagFrame *)tagsFrame{
    ...
    for (NSInteger i=0; i<tagsFrame.tagsArray.count; i++) {
        ...
        [self makeCorner:self.borderSize view:tagsBtn color:[UIColor colorWithHexString:TextColor_66]];
        ...
        if ([obj isKindOfClass:[UIButton class]]) {
            ...
            if (btn.tag == [index integerValue]){
                ...
                if ([selectedBtnList containsObject:index]) {
                    ...
                    btn.backgroundColor = [UIColor whiteColor];
                    [btn setTitleColor:TextColor forState:UIControlStateNormal];
                    [self makeCorner:_borderSize view:btn color:[UIColor colorWithHexString:TextColor_66]];
