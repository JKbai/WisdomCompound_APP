...
#define ForegroundStarImage @"icon_shixinwuxing"
#define BackgroundStarImage @"icon_shixinwuxing_hui"
typedef void(^completeBlock)(CGFloat currentScore);
@interface XBStarRateView()
...
-(void)layoutSubviews {
    ...
    __weak XBStarRateView *weakSelf = self;
