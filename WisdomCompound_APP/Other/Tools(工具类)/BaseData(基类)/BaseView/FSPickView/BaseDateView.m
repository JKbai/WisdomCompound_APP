...
- (UIView *)contentView
{
    if (!_contentView) {
        ...
        _contentView = [[UIView alloc]initWithFrame:CGRectMake(0, SCREENH_HEIGHT, SCREEN_WIDTH, self.pickerViewHeight)];
...
- (UIPickerView *)pickerView
{
    if (!_pickerView) {
        ...
        _pickerView = [[UIPickerView alloc]initWithFrame:CGRectMake(0,  44, self.contentView.frame.size.width, self.contentView.frame.size.height - 44)];
