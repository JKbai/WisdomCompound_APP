...
- (void)viewDidLoad {
    [super viewDidLoad];
      self.view.backgroundColor = [UIColor colorWithHexString:KBackgrourdColor];
    ...
    [tableViewController.view setFrame:CGRectMake(12, 120, SCREEN_WIDTH - 24, 367)];
    ...
    _formTableView.backgroundColor = [UIColor colorWithHexString:KBackgrourdColor];
...
- (void)setTableViewHeight:(CGFloat)tableViewHeight {
    ...
    self.formTableView.height = tableViewHeight;
