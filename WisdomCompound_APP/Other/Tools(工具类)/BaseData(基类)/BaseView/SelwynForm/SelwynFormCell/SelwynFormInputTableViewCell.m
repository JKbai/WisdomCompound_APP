...
{
    CGSize detailSize = [SelwynFormHandle getSizeWithString:item.formDetail Font:FONT(TitleFont) maxSize:CGSizeMake(SCREEN_WIDTH - (TitleWidth + 3*EdgeMarin), MAXFLOAT)];
