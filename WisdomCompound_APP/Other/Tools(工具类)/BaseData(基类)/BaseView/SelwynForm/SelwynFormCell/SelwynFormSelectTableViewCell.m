...
+ (CGFloat)cellHeightWithItem:(SelwynFormItem *)item{
    ...
    CGSize detailSize = [SelwynFormHandle getSizeWithString:item.formDetail Font:FONT(TitleFont) maxSize:CGSizeMake(SCREEN_WIDTH - TitleWidth - 2*EdgeMarin - 30, MAXFLOAT)];
