...
/** cell边缘边距 */
CGFloat const EdgeMarin = 14.0f;
/** 表单标题宽度 */
CGFloat const TitleWidth = 54.0f;
/** 表单标题高度 */
CGFloat const TitleHeight = 13.0f;
/** 表单标题字体大小 */
CGFloat const  TitleFont = 13;
/** 表单textView缺省高度 */
CGFloat const DefaultTextViewHeight = 150.0f;
